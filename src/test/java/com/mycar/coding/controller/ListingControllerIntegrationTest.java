...
class ListingControllerIntegrationTest {
    ...
    void shouldSearchListingsByParameters(final String parameterName, final String parameterValue) {
        ...
        final WebTestClient.ResponseSpec responseSpec = client.get()
                                                              .uri(uriBuilder -> uriBuilder.path(ListingController.SEARCH_LISTINGS)
    ...
    void shouldCreateListingsByJson() {
        // when
        client.post()
                                 .uri(uriBuilder -> uriBuilder.path(ListingController.UPLOAD_JSON_BY_DEALER_IDENTIFIER)
    ...
    void shouldUpdateListingsByJson() {
        ...
        // when
        client.post()
              .uri(uriBuilder -> uriBuilder.path(ListingController.UPLOAD_JSON_BY_DEALER_IDENTIFIER).build(dealer.getIdentifier()))
    ...
    void shouldCreateListingsByCsv() {
        ...
        client.post()
              .uri(uriBuilder -> uriBuilder.path(ListingController.UPLOAD_CSV_BY_DEALER_IDENTIFIER)
                                           .build(dealer.getIdentifier()))
    ...
    private void checkListingExists(final int total, final ListingDto listingDto){
        final WebTestClient.ResponseSpec responseSpec = client.get()
                                                              .uri(uriBuilder -> uriBuilder.path(ListingController.SEARCH_LISTINGS).build())
                                                              .accept(MediaType.APPLICATION_JSON)
                                                              .exchange();
